...
export default {
  ...
  computed: {
    buttonStyles() {
      return "  bg-gray-200 rounded px-4 py-1 text-sm text-secondary bg-white flex justify-center items-center sm:uppercase hover:bg-gray-900 hover:text-white transform duration-500 ease-in-out";
    },
    disabledStyle() {
      return "  bg-gray-200 rounded px-4 py-1 text-sm text-secondary bg-white flex justify-center items-center sm:uppercase text-gray-300";
    },
    totalPages() {
